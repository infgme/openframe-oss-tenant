...
{{- else if and $oss $ossNgrok (eq $name "ingress-nginx") }}
  true
{{- else if and $saas (or (eq $name "openframe-gateway") (eq $name "openframe-external-api") (eq $name "openframe-stream") (eq $name "openframe-config") (eq $name "openframe-client") (eq $name "openframe-api") (eq $name "openframe-authorization-server") (eq $name "ngrok-operator")) }}
  true
